...
@section('content')
    ...
    <!--=============================
            BRAND START
        ==============================-->
    <section class="wsus__brand" style="background: url({{ asset('counter-bg.jpg') }});">
                ...
                <div class="row brand_slider wow fadeInUp" data-wow-duration="1s">
                    <div class="col-xl-2">
                        ...
                        <a class="wsus__single_brand" href="javascript:;">
                            <img src="public/uploads/custom-images/partner-2023-03-05-04-35-57-4275.png" alt="brand"
                    ...
                    <div class="col-xl-2">
                        <a class="wsus__single_brand" href="javascript:;">
                            <img src="public/uploads/custom-images/partner-2023-03-05-04-36-05-2512.png" alt="brand"
                                class="img-fluid w-100">
                        </a>
                    ...
                    <div class="col-xl-2">
                        <a class="wsus__single_brand" href="javascript:;">
                            <img src="public/uploads/custom-images/partner-2023-03-05-04-36-15-7213.png" alt="brand"
                                class="img-fluid w-100">
                        </a>
                    ...
                    <div class="col-xl-2">
                        <a class="wsus__single_brand" href="javascript:;">
                            <img src="public/uploads/custom-images/partner-2023-03-05-04-36-24-3552.png" alt="brand"
                                class="img-fluid w-100">
                        </a>
                    ...
                    <div class="col-xl-2">
                        <a class="wsus__single_brand" href="javascript:;">
                            <img src="public/uploads/custom-images/partner-2023-03-05-04-36-34-1671.png" alt="brand"
                                class="img-fluid w-100">
                        </a>
                    ...
                    <div class="col-xl-2">
                        <a class="wsus__single_brand" href="javascript:;">
                            <img src="public/uploads/custom-images/partner-2023-03-05-04-36-42-1713.png" alt="brand"
                                class="img-fluid w-100">
                        </a>
