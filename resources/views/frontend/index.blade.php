...
@section('content')
    ...
    <!--=============================
        B2B CTA START
    ==============================-->
    <section class="wsus__b2b_cta mt_95 xs_mt_65" style="background: url('{{ asset('website-images/slider-bg.jpg') }}'); background-position: center; background-size: cover; padding: 100px 0; position: relative;">
...
<section class="wsus__search_menu mt_120 xs_mt_90 mb_100 xs_mb_70">
    ...
    <section class="wsus__download mt_100 xs_mt_70">
        <div class="container">
            <div class="wsus__download_bg" style="background: url({{ optional($appSection)->background_image ?? '' }});">
