        ...
        <div class="page-content error-page">
            <div class="container text-center">
                <div class="error-template">
                    <h1 class="error-title mb-2">419</h1>
                    <div class="m-5">
                        <p>Sorry, an error has occurred. The requested page has expired!</p>
                    </div>
                    <div class="text-center">
                        <a class="btn btn-primary mt-5 mb-5" href="/"> <i class="fa fa-long-arrow-left me-2"></i> Back to Home </a>
                    </div>
                </div>
            </div>
        </div>
